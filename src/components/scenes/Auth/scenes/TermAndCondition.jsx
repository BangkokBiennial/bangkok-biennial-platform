  ...
  return (
    <div className="term-and-condition">
      <p className="term-and-condition__text-content">
        Welcome to Bangkok Biennial 2020’s Pavilion Platform! This is
        a standard ‘terms & conditions’ agreement that you must agree
        to in order to proceed using this platform. We know it is a
        bit dull, but... yeah.
      </p>
      <p className="term-and-condition__text-content">
        1. Introduction Welcome to Speedy Grandma Ordinary Partnership
        (“Company”, “we”, “our”, “us”)! These Terms of Service
        (“Terms”, “Terms of Service”) govern your use of our website
        located at bangkokbiennial.com (together or individually
        “Service”) operated by Speedy Grandma Ordinary Partnership.
      ...
      <p className="term-and-condition__text-content">
        ...
        unsubscribe link or by emailing at info@bangkokbiennial.com.
      </p>
      <p className="term-and-condition__text-content">
        3. Contests, Sweepstakes and Promotions Any contests,
        sweepstakes or other promotions (collectively, “Promotions”)
        made available through Service may be governed by rules that
        are separate from these Terms of Service. If you participate
        in any Promotions, please review the applicable rules as well
        as our Privacy Policy. If the rules for a Promotion conflict
        with these Terms of Service, Promotion rules will apply.
      </p>
      <p className="term-and-condition__text-content">
        4. Content Our Service allows you to post, link, store, share
        ...
        infringing on a copyright. You retain any and all of your
        rights to any Content you submit, post or display on or
        through Service and you are responsible for protecting those
        rights. We take no responsibility and assume no liability for
        Content you or any third party posts on or through Service.
        However, by posting Content using Service you grant us the
        ...
        to make your Content available to other users of Service, who
        may also use your Content subject to these Terms. Speedy
        Grandma Ordinary Partnership has the right but not the
        obligation to monitor and edit all Content provided by users.
        In addition, Content found on or through this Service are the
        property of Speedy Grandma Ordinary Partnership or used with
      ...
      <p className="term-and-condition__text-content">
        5. Prohibited Uses You may use Service only for lawful
      ...
      <p className="term-and-condition__text-content">
        6. Analytics We may use third-party Service Providers to
        monitor and analyze the use of our Service.
      </p>
      <p className="term-and-condition__text-content">
        7. No Use By Minors Service is intended only for access and
        use by individuals at least eighteen (18) years old. By
        accessing or using Service, you warrant and represent that you
        are at least eighteen (18) years of age and with the full
        authority, right, and capacity to enter into this agreement
        and abide by all of the terms and conditions of Terms. If you
        are not at least eighteen (18) years old, you are prohibited
      ...
      <p className="term-and-condition__text-content">
        ...
        Speedy Grandma Ordinary Partnership and its licensors. Service
        ...
        written consent of Speedy Grandma Ordinary Partnership.
      </p>
      <p className="term-and-condition__text-content">
        10. Copyright Policy We respect the intellectual property
        rights of others. It is our policy to respond to any claim
        that Content posted on Service infringes on the copyright or
        other intellectual property rights (“Infringement”) of any
        person or entity. If you are a copyright owner, or authorized
        on behalf of one, and you believe that the copyrighted work
        has been copied in a way that constitutes copyright
        infringement, please submit your claim via email to
        info@bangkokbiennial.com, with the subject line: “Copyright
      ...
      <p className="term-and-condition__text-content">
        ...
        <ul>
          ...
          info@bangkokbiennial.com.
        </ul>
      </p>
      <p className="term-and-condition__text-content">
        12. Error Reporting and Feedback You may provide us either
        directly at info@bangkokbiennial.com or via third party sites
        and tools with information and feedback concerning errors,
        suggestions for improvements, ideas, problems, complaints, and
        other matters related to our Service (“Feedback”). You
        acknowledge and agree that: (i) you shall not retain, acquire
        or assert any intellectual property right or other right,
      ...
      <p className="term-and-condition__text-content">
        ...
        controlled by Speedy Grandma Ordinary Partnership. Speedy
        Grandma Ordinary Partnership has no control over, and assumes
        ...
        their websites. For example, the outlined Terms of Service
        have been created using PolicyMaker.io, a free web application
        for generating high-quality legal documents. PolicyMaker’s
        free Terms and Conditions generator is an easy-to-use free
        tool for creating an excellent standard Terms of Service
      ...
      <p className="term-and-condition__text-content">
        14. Disclaimer Of Warranty THESE SERVICES ARE PROVIDED BY
        COMPANY ON AN “AS IS” AND “AS AVAILABLE” BASIS. COMPANY MAKES
      ...
      <p className="term-and-condition__text-content">
        15. Limitation Of Liability EXCEPT AS PROHIBITED BY LAW, YOU
        WILL HOLD US AND OUR OFFICERS, DIRECTORS, EMPLOYEES, AND
        AGENTS HARMLESS FOR ANY INDIRECT, PUNITIVE, SPECIAL,
      ...
      <p className="term-and-condition__text-content">
        ...
        whatsoever and without limitation, including but not limited
        to a breach of Terms. If you wish to terminate your account,
        you may simply discontinue using Service. All provisions of
      ...
      <p className="term-and-condition__text-content">
        ...
        in accordance with the laws of THAILAND, which governing law
      ...
      <p className="term-and-condition__text-content">
        ...
        we may restrict access to some parts of Service, or the entire
      ...
      <p className="term-and-condition__text-content">
        21. Acknowledgement BY USING SERVICE OR OTHER SERVICES
        PROVIDED BY US, YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS
        OF SERVICE AND AGREE TO BE BOUND BY THEM.
      </p>
      <p className="term-and-condition__text-content">
        22. Contact Us Please send your feedback, comments, requests
        for technical support by email: info@bangkokbiennial.com.
      </p>
    </div>
  )
}
